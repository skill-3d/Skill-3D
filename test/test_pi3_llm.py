...
from skill3d.tools import DepthEstimationTool, SegmentationTool, ObjectDetectionTool, MoondreamTool, Pi3Tool
...
# 3. 选择和配置工具
tools = [
    Pi3Tool(use_mock=False, server_url=os.environ.get("PI3_SERVER_URL", "http://127.0.0.1:20030"))
]
...
agent = SPAgent(
    model=model, 
    tools=tools, 
    max_workers=16  # 并行工具数量
)

# 5. 解决问题 - 视频测试
video_path = os.environ.get(
    "PI3_TEST_VIDEO",
    str(project_root / "dataset/VSI_videos/scannetpp_b0a08200c9.mp4"),
)
num_frames = 50  # 均匀采样10帧
