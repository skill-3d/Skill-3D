...
class SupervisionTool(Tool):
    ...
    def _init_client(self):
        ...
        if self.use_mock:
            try:
                from skill3d.external_experts.supervision.mock_supervision_service import MockSupervisionService
            ...
            try:
                from skill3d.external_experts.supervision.supervision_client import AnnotationClient
