...
class YOLOETool(Tool):
    ...
    def _init_client(self):
        ...
        if self.use_mock:
            try:
                from skill3d.external_experts.supervision.mock_yoloe_service import MockYOLOEService
            ...
            try:
                from skill3d.external_experts.supervision.sv_yoloe_client import AnnotationClient
