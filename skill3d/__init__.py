"""
Skill-3D - Scene-aware spatial reasoning agent
...
Usage:
    ...
    from skill3d.models import GPTModel
    from skill3d.tools import DepthEstimationTool, SegmentationTool
...
# Core components
from .core import SPAgent, Tool, ToolRegistry, Model, AdaptiveSkillManager
...
__version__ = '2.0.0'
__all__ = ['SPAgent', 'Tool', 'ToolRegistry', 'Model', 'AdaptiveSkillManager', 'models', 'tools', 'utils']
...
try:
    ...
    warnings.warn(
        ...
        "Please migrate to the new Skill-3D architecture.",
        DeprecationWarning,
        stacklevel=2
    )
except ImportError:
