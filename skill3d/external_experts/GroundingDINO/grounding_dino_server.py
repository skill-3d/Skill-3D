...
file_handler = logging.FileHandler(os.path.join(log_dir, 'grounding_dino_server.log'))
...
def load_grounding_dino_model(model_path=None):
    ...
    try:
        ...
        # 加载模型
        model = load_model("skill3d/external_experts/GroundingDINO/configs/GroundingDINO_SwinB_cfg.py", model_path)
